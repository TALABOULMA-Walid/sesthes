...
\newlength{\jeroenlen}
\newenvironment{subjecto}
 {\settowidth{\jeroenlen}{\textbf{Subject to:}}%
  \begin{description}[leftmargin=\jeroenlen,labelwidth=0pt,labelsep=0pt]
  \item[\textbf{Subject to:}]%
  \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,label={},leftmargin=\fontdimen2\font]}
...
\setlength{\textbaselineskip}{15pt}
...
\include{text/ch2-bkgnd}
\include{text/ch3-state}
\include{text/ch4-model}
\include{text/ch5-sched}
\include{text/ch6-eval}
\include{text/ch7-concl}
