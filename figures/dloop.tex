...
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,right of = o5_1,xshift=.5cm,fill=red!20] (o10_1) {$o_{10}^{p+1}$};
...
\path ([xshift=.2cm,yshift=-.1cm]o10_1.south) edge[<-,dashed,red] (c1.north);
\path ([yshift=-.1cm]c1.south) edge[out = 270,in=0,dashed,red] (c2.west);
\path (c2.west) edge[dashed,red] ([xshift=.1cm]o10_0.east);

\node[draw=none,below of = o10_0,yshift=1cm,text=red] {$4$};
\node[draw=none,below of = o6,text=red] {+$HP$};
