...
% Nodes
\node[fill=red!20] (o5) {$o_5^q$};
\node[above of = o5,yshift=1cm] (o4) {$o_4^q$};
\node[right of = o4,yshift=-.5cm] (o8) {$o_8^q$};
\node[right of = o8,yshift=-.5cm] (o1) {$o_1^q$};
\node[right of = o1] (o7) {$o_7^q$};
\node[right of = o7] (o2) {$o_2^q$};
\node[square,right of = o2,yshift=-.5cm] (o11) {$o_{11}^q$};
\node[square,below of = o2] (o10) {$o_{10}^q$};
\node[below of = o10,yshift=.5cm] (o3) {$o_3^q$};
\node[left of = o3,yshift=-.5cm] (o6) {$o_6^q$};
\node[left of = o6] (o0) {$o_0^q$};
\node[left of = o0,yshift=-.5cm] (o9) {$o_9^q$};

\node[right of = o11,yshift=.5cm,inner sep=0] (o1_1) {$o_1^{q+1}$};
\node[below of = o1_1,inner sep=0] (o5_1) {$o_5^{q+1}$};
\node[below of = o5_1,inner sep=0] (o0_1) {$o_0^{q+1}$};
\node[right of = o1_1,inner sep=0] (o7_1) {$o_7^{q+1}$};
\node[right of = o0_1,inner sep=0] (o6_1) {$o_6^{q+1}$};
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,right of = o5_1,xshift=.5cm] (o10_1) {$o_{10}^{q+1}$};
...
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,dashed,fill=red!20] at(input |- c2) (o10_0) {$o_{10}^{q-1}$};
\path (o10_0) edge[-{Latex[]},red]  (o5);

\path ([yshift=-.1cm]o5.south) edge[->,dashed,red, bend left = 20, line width=.5]  ([xshift=.1cm,yshift=.1cm]o10_0.east);
