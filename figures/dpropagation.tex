...
% Nodes
\node[fill=red!20] (o5) {$o_5^p$};
\node[above of = o5,yshift=1cm] (o4) {$o_4^p$};
\node[right of = o4,yshift=-.5cm] (o8) {$o_8^p$};
...
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,right of = o5_1,xshift=.5cm] (o10_1) {$o_{10}^{p+1}$};
...
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,dashed,fill=red!20] at(input |- c2) (o10_0) {$o_{10}^{p-1}$};
