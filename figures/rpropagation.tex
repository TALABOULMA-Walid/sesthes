...
\path (o4) edge[-{Latex[]},draw=blue] (o8);
\path (o4) edge[-{Latex[]},bend left=30,draw=blue] (o11);
\path (o8) edge[-{Latex[]},draw=blue] (o1);
\path (o8) edge[-{Latex[]},bend left=30,draw=blue] (o11);
\path (o1) edge[-{Latex[]},draw=blue] (o7);
\path (o1) edge[-{Latex[]},bend right=15,draw=blue] (o10);
\path (o7) edge[-{Latex[]},draw=blue] (o2);
\path (o7) edge[-{Latex[]},draw=blue] (o10);
\path (o2) edge[-{Latex[]},draw=blue]  (o11);
...
\path (o5_1) edge[-{Latex[]},draw=blue]  (o10_1);
\path (o6_1) edge[-{Latex[]},draw=blue]  (o10_1);
\path (o7_1) edge[-{Latex[]},draw=blue]  (o10_1);
\path (o0_1) edge[-{Latex[]},draw=blue]  (o10_1);
\path (o1_1) edge[-{Latex[]},draw=blue]  (o10_1);

\path (o10) edge[-{Latex[]},bend right = 25,draw=blue]  (o1_1);
\path (o1) edge[-{Latex[]},bend left = 25,draw=blue]  (o1_1);
\path (o8) edge[-{Latex[]},bend left = 25,draw=blue]  (o1_1);

\path (o10) edge[-{Latex[]},draw=blue]  (o5_1);
\path (o5) edge[-{Latex[]},bend right = 12]  (o5_1);

\path (o10) edge[-{Latex[]},draw=blue]  (o0_1);
\path (o0) edge[-{Latex[]},bend right = 25]  (o0_1);
\path (o9) edge[-{Latex[]},bend right = 10]  (o0_1);

\path (o10) edge[-{Latex[]},bend right = 10,draw=blue]  (o7_1);
\path (o1_1) edge[-{Latex[]},draw=blue]  (o7_1);
\path (o7) edge[-{Latex[]},bend left = 30,draw=blue]  (o7_1);

\path (o10) edge[-{Latex[]},bend left = 8,draw=blue]  (o6_1);
\path (o0_1) edge[-{Latex[]},draw=blue]  (o6_1);
\path (o6) edge[-{Latex[]},bend right = 30]  (o6_1);

\path (o10) edge[-{Latex[]},bend left = 19,draw=blue]  (o10_1);
...
\path (output) edge[-{Latex[]},draw=blue]  (o4);
