...
\node[below of = o10,yshift=.5cm,fill=blue!20] (o3) {$o_3^p$};
\node[left of = o3,yshift=-.5cm,fill=blue!20] (o6) {$o_6^p$};
\node[left of = o6,fill=blue!20] (o0) {$o_0^p$};
\node[left of = o0,yshift=-.5cm,fill=blue!20] (o9) {$o_9^p$};
...
\path (o9) edge[-{Latex[]},blue]  (o0);
\path (o9) edge[-{Latex[]}, out=340,in=270]  (o11);
\path (o0) edge[-{Latex[]},blue]  (o6);
\path (o0) edge[-{Latex[]},bend left=15]  (o10);
\path (o6) edge[-{Latex[]},blue]  (o3);
...
\node[regular polygon,regular polygon sides=4,inner sep=-3.4,dashed,fill=gray!50] at(output |- c2) (o10_0) {$o_{10}^{p-1}$};
\path (o10_0) edge[-{Latex[]},blue]  (o5);

\node[regular polygon,regular polygon sides=4,inner sep=-3.4,right of = o10_0,dashed,fill=gray!50]  (o11_0) {$o_{11}^{p-1}$};
\path (o11_0) edge[-{Latex[]},blue]  (o9);


%\path ([xshift=.2cm,yshift=-.1cm]o10_1.south) edge[dashed,blue] (c1.north);
%\path ([yshift=-.1cm]c1.south) edge[out = 270,in=0,dashed,blue] (c2.west);
%\path (c2.west) edge[->,dashed,blue] ([xshift=.1cm]o10_0.east);
%
\node[draw=none,above of = o10_0,yshift=-1cm,text=blue] {-$4$};
\node[draw=none,above of = o11_0,yshift=-1cm,text=blue] {-$4$};
%\node[draw=none,below of = o6,text=blue] {-$HP$};
