...
\begin{axis}[
    ...
    ymin=0,ymax=2.7,
		...
		\draw [->,densely dashed] (2.2,2.5) -- node [align=center,fill=white] {$x_{n+1}$} (2.2,2);
		\draw [->,densely dashed] (3,2.5) -- node [align=center,fill=white] {$x_{n+2}$} (3,2);
		
		
		
		\node at (0.8,2.6) {$f(x_{n-1},t_n)$};
		\node at (1.65,2.6) {$f(x_{n},t_{n+1})$};
		\node at (2.6,2.6) {$f(x_{n+1},t_{n+2})$};
