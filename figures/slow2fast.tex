...
\node at (axis cs:.25,0.1) {$o_j^{0}$};
\node at (axis cs:1.75,0.1) {$o_j^1$};
\node at (axis cs:3.25,0.1) {$o_j^{2}$};
\node at (axis cs:4.75,0.1) {$o_j^{3}$};

\draw [->] (0.25,0.2) -- (0.25,0.6);
\path (1.75,0.2) edge[->,out=90,in=270] (2.25,0.6);
\draw [->] (3.25,0.2) -- (3.25,0.6);
\path (4.75,0.2) edge[->,out=90,in=270] (5.25,0.6);
...
\node at (axis cs:.25,0.1) {$o_i^{0}$};
\node at (axis cs:1.25,0.1) {$o_i^1$};
\node at (axis cs:2.25,0.1) {$o_i^{2}$};
\node at (axis cs:3.25,0.1) {$o_i^{3}$};
\node at (axis cs:4.25,0.1) {$o_i^{4}$};
\node at (axis cs:5.25,0.1) {$o_i^{5}$};
