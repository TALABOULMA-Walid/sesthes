...
\draw ([yshift=0.8cm]fmu1.west) -- ([yshift=-0.8cm]fmu1.east);
\draw ([yshift=0.8cm]fmu1.west) -- (fmu1.east);
\draw ([yshift=-0.8cm]fmu1.west) -- ([yshift=-0.8cm]fmu1.east);
% FMU2
\node[rectangle,draw,minimum height = 2.4cm,minimum width = 2cm, xshift=4cm] (fmu2) {};
...
\draw ([yshift=0.8cm]fmu2.west) -- ([yshift=-0.8cm]fmu2.east);
