...
An automatic parallelization approach based on task graph scheduling is presented in \cite{aronsson:2006}. For this, the simulation code is analyzed at the expression level to build the task graph. A clustering algorithm is, also, proposed in this work to merge tasks. Finally an offline scheduling heuristic is applied on the task graph.
