...
The parallelization approaches can be classified into three categories as suggested in [burrage], based on the level at which the parallelization is intorduced.
