...
Lastly, the loop forward phase of propagation is performed, always, in an increasing order of the deadline constraints. Algorithm details the prposed algorithm for the propagation of deadline constraints.     
