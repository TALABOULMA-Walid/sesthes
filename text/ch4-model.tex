...
\subsection{Accounting for Execution Times}
...
Let $o_i$ and $o_j$ be two operations such that $o_j \in pred(o_i)$. For a given schedule of the operation graph to be valid, the relations $S(o_i) >$ and $$ must be satisfied. 
