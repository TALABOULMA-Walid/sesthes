...
Real-time systems are based on real-time tasks which represent the basic units of computation. In the context of co-simulation under real-time constraints, the operations of the co-simulation represent the real-time tasks. The real-time requirements that we define here consist in real-time parameters that are assigned to operations.
