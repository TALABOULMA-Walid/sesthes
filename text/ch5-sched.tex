...
As shown in Section \ref{sec:grphrtsc}, the propagation of the real-time constraints in an operation graph may lead to assigning negative release dates to some operations. This means, that such operations can be executed before launching the co-simulation under real-time constraints. Therfore, they do not appear in the first repetition of the schedu
