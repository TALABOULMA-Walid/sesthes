...
We implemented a parallelization approach of FMI co-simulations using the Intel TBB flow graph interface for the purpose of comparing it with our proposed offline scheduling approach. We have measured the speedups obtained on different numbers of cores using both approaches. First of all, let's summarize the differences between the two approaches. Figure illustrates the main steps of both approaches.
